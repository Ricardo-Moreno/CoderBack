...
const resetPasswordRequest = async (req, res) => {
    res.render('resetPasswordRequest', { title: 'Lets recover your password', style: 'login.css' });
}

const resetPassword = async (req, res) => {
    res.render('resetPassword', { title: 'Lets recover your password', email: req.email, token: req.token, style: 'login.css' });
}
